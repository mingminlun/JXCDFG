...
cdfg = pd.read_csv('C:\Work\JXWLJG\\08_030405\MRO-CDFG-20170804-all.csv',encoding = 'utf-8')
del cdfg['\t']
...
cdfg2 = pd.merge(cdfg2,base1.loc[:,['CGI','覆盖类型','网格','地市','区县','覆盖场景','厂家名称','经度','纬度','工作频段',]],le\
    ft_on = 'CGI.1',right_on = 'CGI',how ='left')
